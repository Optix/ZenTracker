...
class sfFactoryConfigHandler extends sfYamlConfigHandler
{
  ...
  public function execute($configFiles)
  {
    ...
    $factories = array('cache', 'view_cache_manager', 'logger', 'i18n', 'controller', 'request', 'response', 'routing', 'storage', 'user', 'view_cache', 'mailer');
